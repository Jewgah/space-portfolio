        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <span className="absolute left-8 top-5 font-mono text-[10px] uppercase tracking-[0.3em] text-white/70">
                {ui.modal.brief}
              </span>
            ...
            <div className="p-8">
              ...
              <div className="mt-8 flex items-center justify-between gap-4">
                {project.link && (
                  ...
                  >
                    {project.linkLabel ?? ui.modal.visit} ▸
                  </a>
                )}
